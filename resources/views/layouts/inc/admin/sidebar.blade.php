<div class="vertical-menu">
    ...
    <div data-simplebar class="h-100">
        ...
        <div class="user-profile text-center mt-3">
            <div class="">
                <img src="{{asset('panel/assets/images/users/avatar-1.jpg')}}" alt="" class="avatar-md rounded-circle">
            </div>
            <div class="mt-3">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('admin.showCreateCategory')}}">Add Category</a></li>
                        <li><a href="{{route('admin.categories')}}">View Category</a></li>
                    </ul>
                </li>
