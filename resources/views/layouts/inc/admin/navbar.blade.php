        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{route('admin.index')}}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{asset("panel/assets/images/logo-sm.png")}}" alt="logo-sm" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{asset("panel/assets/images/logo-dark.png")}}" alt="logo-dark" height="20">
                    </span>
                </a>

                <a href="{{route('admin.index')}}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{asset("panel/assets/images/logo-sm.png")}}" alt="logo-sm-light" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{asset("panel/assets/images/logo-light.png")}}" alt="logo-light" height="20">
                    </span>
                </a>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div>
                                        <img src="{{asset("panel/assets/images/megamenu-img.png")}}" alt="megamenu-img" class="img-fluid mx-auto d-block">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-sm-inline-block">
                <button type="button" class="btn header-item waves-effect"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="" src="{{asset('panel/assets/images/flags/us.jpg')}}" alt="Header Language" height="16">
                </button>
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <div class="px-lg-2">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{asset('panel/assets/images/brands/mail_chimp.png')}}" alt="mail_chimp">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="#" class="text-reset notification-item">
                            <div class="d-flex">
                                <img src="{{asset("panel/assets/images/users/avatar-4.jpg")}}"
                                    class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                <div class="flex-1">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{asset('panel/assets/images/users/avatar-1.jpg')}}"
                        alt="Header Avatar">
